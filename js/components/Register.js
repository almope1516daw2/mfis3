...
class Register extends React.Component {
    ...
    saveRegister = () => {
        ...
        let onFailure = (transaction) => {
            let error = transaction.getError().source || new Error('Mutation failed.');
            console.error(error);
            console.error("## ERROR ##");
        };
        let mutation = new RegisterMutation({
        ...
        component =
            <ReactBootstrap.Col lg={12} md={12} id="Register">
                ...
                <form id="form">
                    ...
                    <FaEye id="viewPassword" onMouseOver={this.mouseoverPass} onMouseOut={this.mouseoutPass}/><span
                    id="spanPassword"> </span><br/>
                    <ReactBootstrap.Row>
